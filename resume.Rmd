...
- Emma is currently a Junior Data Scientist at MassMutual in their Data Science Development Program, and is working towards a masters degree in computer science at UMass Amherst.
...
- Nominee for the 2020 Impact Awards through the [Wurtele Center for Leadership](https://www.smith.edu/about-smith/wurtele-center). 
- 2018 winner of "Best in Group" at Five College DataFest with team A-super-NOVA. Presented a new "competitiveness index" for Indeed.com based on number of jobs, number of applications, and how long jobs have been posted by field and region.

**Spinelli Center Stats Tutor and Data Assistant, Spring 2019 - Spring 2020**

- Provided one-on-one and group tutoring in introductory level statistics classes, assisted students with introductory data science concepts such as data wrangling and visualization. 
...
- Facilitated the transition to remote learning and community building.
